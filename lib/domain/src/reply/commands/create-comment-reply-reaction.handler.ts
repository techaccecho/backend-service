...
import {
  ...
  toCreateCommentReplyReactionArgs,
} from './create-comment-reply-reaction.command.js';

@injectable()
@requestHandler(CreateCommentReplyReactionCommand)
export class CreateCommentReplyReactionHandler
  implements RequestHandler<CreateCommentReplyReactionCommand, BlogData>
{
  constructor(
  ...
  async handle(command: CreateCommentReplyReactionCommand): Promise<BlogData> {
