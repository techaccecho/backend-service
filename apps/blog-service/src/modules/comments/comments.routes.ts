...
export const commentsRoutes: FastifyPluginAsyncTypebox = async (fastify) => {
  ...
  fastify.post(
    ...
    async (request, reply) => {
      ...
      const command = new CreateCommentViewerCommand({
        params,
        create: body,
        blog,
        comment,
  ...
  fastify.post(
    ...
    async (request, reply) => {
      ...
      const command = new CreateCommentReactionCommand({
        params,
        create: body,
        blog,
        comment,
  ...
  fastify.patch(
    '/blogs/:blogId/comments/:commentId/reactions/:reactionId',
    {
      ...
      preHandler: [
        authenticate,
        verifyUpdateCommentReactionHook(convex, validation),
      ],
    },
    async (request, reply) => {
      ...
      const command = new UpdateCommentReactionCommand({
        params,
        update: body,
        existing: reaction,
        blog,
  ...
  fastify.delete(
    ...
    async (request, reply) => {
      ...
      const command = new DeleteCommentReactionCommand({
        params,
        existing: reaction,
        blog,
        comment,
